...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <h1 class="h3 mb-1 fw-semibold">Create New Supplier</h1>
            <p class="text-muted mb-0">Fill in the details below to add a new supplier</p>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form method="POST" action="{{ route('suppliers.store') }}" id="supplierForm">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <x-form.input name="name" label="Name" :value="old('name')" placeholder="Enter supplier name" required />
                    </div>
                    <div class="col-md-6">
